...
if (isset($_POST['add_fac'])) {
    ...
    $user_check_query = "SELECT * FROM facility WHERE facility_name='$fac_name' LIMIT 1";
    $result = mysqli_query($db, $user_check_query);
    $check = mysqli_fetch_assoc($result);  

  if ($check == true) {
    //array_push($errors);
    echo "<script>alert('Facility already exist');
  window.location.href='admin_add_facility.php';
  </script>";
  }else if ($check == false) {

    $query1 = "INSERT INTO facility (facility_name, location_latitude, location_longitude) 
    VALUES('$fac_name', '$latitude' , '$longitude')";
        mysqli_query($db, $query1);
		
        echo "<script>alert('New Facility Added Successfully');
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Add New Facility</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="exampleModalLongTitle">Add New Facility</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Are you sure to add new facility?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">Close</button>
                                                                            <button type="submit" class="btn btn-primary"
                                                                                name="add_fac">Submit</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
