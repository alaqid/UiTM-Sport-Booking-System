                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Facility Booking</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-xl-7">
                        <div class="card">
                            <div class="card-body">
                                <form method="post">
                                    <div class="mb-4">
                                        <h4 class="card-title">Select facility</h4>
                                    </div>
                                    <input id="bookingID" type="text" hidden value="<?php echo $_GET["bookingID"]; ?>">
                                    <select id="single-select" name="select_fac">
                                        <option selected disabled value="">Please select facility</option>
                                        <option selected value="<?php echo $rows['item_name']; ?>">
                                    ...
                                    <input type="date" name="datepicker" class="form-control" id="datepicker"
                                        value="<?php echo $rows['bookdate']; ?>" required>
                                    <br><br>
                                ...
                                if (isset($_POST['check_avail'])) {
                                    ...
                                    $user_check_query = "SELECT * FROM booking_records WHERE item_name='$select_fac' AND bookdate='$datepicker1' AND booktime='$booktime1' AND book_status!='Ended' LIMIT 1";
                                    ...
                                    if ($check == true) { 
                                        ...
                                        echo '<label style="color:red;border: 2px solid black;">The facility has been booked on the date and time. Please choose another time and date      
                                        </label><br>';

                                        

                                        } else if ($check == false) {
                                            echo '<label style="color:green;border: 2px solid black;">The facility for that date and time is available  
                                          </label>';
                                          echo ' <br><br><button  class="btn btn-primary btn-sl-sm mb-5" type="submit" style="float: right;" name="book_facility">Submit</button>';
                                        } else {
                                            echo "<label hidden>The facility for that date and time is available  
                                          </label>";
                                        }
                                ...
                                ?>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <input class="btn btn-info" type="submit" name="check_avails"
                                                        value="Check Availability"
                                                        onclick="return chk()"></input>
                                                        <hr>
                                                    <p id="msg"></p>
                                                </div>
                                    ...
                                    <br><br><label style="color:red">Please check the availability of the selected time
                                        <br>and date
