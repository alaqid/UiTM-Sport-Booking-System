                                        ...
                                        <tbody>                                   
                                            <tr>
                                                ...
                                                if ($rows["booking_type"] == 'Equipment'){
                                                    ...
                                                    echo '<td style="color:#575757"><a href="user_booking_return_view.php?bookingID='.$rows["bookingID"].'"<button class="btn btn-info">Ended - View Proof</button></a></td>';

                                                }else{
                                                    echo '<td style="color:#575757">'.$rows['book_status'].'</td>';
                                                }
                                                ...
                                                if ($rows["booking_type"] == 'Equipment'){
                                                    ...
                                                    echo '<td style="color:#575757"><a href="admin_booking_edit_equipment.php?bookingID='.$rows["bookingID"].'"<button class="btn btn-info">Edit</button></a></td>';

                                                }else{
                                                    echo '<td style="color:#575757"><a href="admin_booking_edit_facility.php?bookingID='.$rows["bookingID"].'"<button class="btn btn-info">Edit</button></a></td>';
                                                }
