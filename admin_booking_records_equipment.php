...
$sql="SELECT * FROM booking_records WHERE booking_type = 'Equipment' ORDER BY bookingID DESC";
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Equipment Booking Records</h4>                            
                        </div>
                        <div class="col-sm-7 p-md-0"><br>
                            <table>
                                <form method="post">
                                    <tr>
                                        <td><select required class="form-control" name="month1" id="month1">
                                        ...
                                        <td><select required class="form-control" name="year1" id="year1">
                                            <option selected disabled value="">Select year</option>
                                                <option value="2021">2021</option>
                                                <option value="2022">2022</option>
                                            </select></td><br>
                                        <td><button type="submit" class="btn btn-primary"
                                                name="filterss">Submit</button></td>
                                    </tr>
                                </form>
                            </table>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">                                
                                    ...
                                    <thead>
                                        ...
                                        if (isset($_POST['filterss'])) {
                                            
                                            $month1 = mysqli_real_escape_string($db, $_POST['month1']);
                                            $year1 = mysqli_real_escape_string($db, $_POST['year1']);
    

                                         $sql="SELECT * FROM booking_records WHERE booking_type = 'Equipment' AND bookdate LIKE '%-$month1-%' AND bookdate LIKE '%$year1%' ORDER BY bookingID DESC";
                                         $result=mysqli_query($db,$sql);	
                                        ...
                                        <tbody>                                   
                                            <tr>
                                                ...
                                                <td style="color:#575757"><?php echo $rows['feedback']; ?></td>                                        
                                                ...
                                                <td style="color:#575757"><a href="admin_booking_edit_equipment.php?bookingID=<?php echo $rows["bookingID"]; ?>"> <button class="btn btn-warning">Edit</button></a>
                                                <a href="user_booking_return_view.php?bookingID=<?php echo $rows["bookingID"]; ?>"> <button class="btn btn-info">View Proof</button></a></td>
                                                <?php }}?>
                                            </tr>
                                        </tbody>
                                        <tfoot>
