                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        if (isset($_POST['filterss'])) {
                                            ...
                                            $sql="SELECT * FROM booking_records WHERE booking_type = 'Facility' AND bookdate LIKE '%-$month1-%' AND bookdate LIKE '%$year1%' ORDER BY bookingID DESC";
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="color:#575757"><a
                                                        href="app-profile2.php?userID=<?php echo $rows["userID"]; ?>">
                                                        <button class="btn btn-primary">View Profile</button></a></td>
                                                <td style="color:#575757"><a
                                                        href="admin_booking_edit_facility.php?bookingID=<?php echo $rows["bookingID"]; ?>">
