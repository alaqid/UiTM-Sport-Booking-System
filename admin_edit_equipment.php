...
if (isset($_POST['edit_equip'])) {
    ...
    $query ="UPDATE equipment SET equipment_name='".$equip_name."'WHERE equipmentID='".$equipmentID."'";

        mysqli_query($db, $query);
		
        echo "<script>alert('Equipment Updated Successfully');
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="exampleModalLongTitle">Edit Equipment</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Are you sure to edit equipment?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">Close</button>
                                                                            <button type="submit" class="btn btn-primary"
                                                            name="edit_equip">Save changes</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
