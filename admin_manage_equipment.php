            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        ...
                        <div>
                        <a href="admin_add_equipment.php"><button class="btn btn-success">Add Equipment</button></a>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Manage Equipment</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">                                
                                    ...
                                    <thead>
                                        ...
                                        <tbody>                                   
                                            <tr>
                                                <td style="color:#575757"><?php echo $rows['equipment_name']; ?></td>                                        
                                                <td style="color:#575757"><a href="admin_edit_equipment.php?equipmentID=<?php echo $rows["equipmentID"]; ?>"> <button class="btn btn-info">Edit</button></a></td>                                                
