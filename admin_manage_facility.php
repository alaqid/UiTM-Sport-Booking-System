            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        ...
                        <div>
                        <a href="admin_add_facility.php"><button class="btn btn-success">Add Facility</button></a>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Manage Facility</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">                                
                                    ...
                                    <thead>
                                        ...
                                        <tbody>                                   
                                            <tr>
                                                <td style="color:#575757"><?php echo $rows['facility_name']; ?></td>
                                                <td style="color:#575757"><?php echo $rows['location_latitude']; ?></td>
                                                <td style="color:#575757"><?php echo $rows['location_longitude']; ?></td>
                                                <td style="color:#575757"><a href="https://www.google.com/maps/dir//<?php echo $rows["location_latitude"]; ?>,<?php echo $rows["location_longitude"]; ?>" target="_blank"> <button class="btn btn-primary">Navigate</button></a></td>
                                                <td style="color:#575757"><a href="admin_edit_facility.php?facilityID=<?php echo $rows["facilityID"]; ?>"> <button class="btn btn-info">Edit</button></a></td>                                                
