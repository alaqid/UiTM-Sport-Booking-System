...
$sql="SELECT * FROM booking_records WHERE userID = $userID ORDER BY bookingID DESC";
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            ?>
                            <h4><?php echo $rows2['Uname']; ?>'s Booking Records</h4><?php }?>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                if ($rows["booking_type"] == 'Equipment'){
                                                    ...
                                                    echo '<td style="color:#575757"><a href="admin_booking_edit_equipment.php?bookingID='.$rows["bookingID"].'"<button class="btn btn-warning">Edit</button></a></td>';

                                                }else{
                                                    echo '<td style="color:#575757"><a href="admin_booking_edit_facility.php?bookingID='.$rows["bookingID"].'"<button class="btn btn-warning">Edit</button></a></td>';
                                                }
                                                
                                                ?> 
                                                <?php
                                                
                                                if ($rows["booking_type"] == 'Equipment' && $rows["book_status"] == 'Ended' ){
                                                    
                                                    echo '<td><a href="user_booking_return_view.php?bookingID='.$rows["bookingID"].'"<button class="btn btn-info">View Proof</button></a></td>';
