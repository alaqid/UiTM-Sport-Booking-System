(function($) {
    ...
    var countbadmintonracket = document.getElementById("countbadmintonracket").value;
    var countbadmintonshuttlecock = document.getElementById("countbadmintonshuttlecock").value;
...
var chart = new Chartist.Line('#smil-animations', {
  ...
  new Chartist.Bar('#stacked-bar-chart', {
    ...
    series: [
      [200000, 400000, 500000, 300000, 300000],
      [200000, 400000, 500000, 300000, 300000]
    ]
  }, {
    stackBars: true,
  ...
  new Chartist.Bar('#horizontal-bar-chart', {
    labels: ['Badminton Racket', 'Badminton Shuttlecock', 'Basketball', 'Jump Ropes', 'Volleyball', 'Football', 'Handball', 'Hockey Stick','Softball', 'Rugby Ball', 'Petanque', 'Tennis Racket', 'Tennis Ball', 'Table Tennis'],
    series: [
      [countbadmintonracket+2, countbadmintonshuttlecock+2, 43, 27, 35, 50, 73,14, 33, 47, 35, 30, 23,50]
    ]
  }, {
  ...
  new Chartist.Bar('#horizontal-bar-chart2', {
    labels: ['Futsal Court', 'Basketball Court', 'Laman Woodball', 'Padang Rani	', 'Volleyball Court', 'Netball Court', 'Padang Ragbi Jati', 'Petanque','Badminton Court', 'Tennis Court'],
    series: [
      
      [63, 82, 59, 85, 34, 76, 84, 57, 89, 47]
    ]
  }, {
    seriesBarDistance: 100,
    reverseData: true,
