                                ...
                                <div class="auth-form">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary btn-block" name="login_user">Sign me in</button>
                                        </div>
                                    </form>
                                    ...
                                    <div class="new-account mt-3">
                                        <p>Login as Admin? <a class="text-primary" href="./page-login-admin.php">Click Here</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
