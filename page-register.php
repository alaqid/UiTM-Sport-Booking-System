                                ...
                                <div class="auth-form">
                                    ...
                                    <form method="post" action="page-register.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="hello@example.com" name="Uemail">
                                        </div>                                        
                                        <div class="form-group">
                                            <label><strong>Password</strong></label>
                                            <input type="password" class="form-control" name="userPass1">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="submit" class="btn btn-primary btn-block" name="reg_user">Sign me up</button>
                                        </div>
                                    </form>
