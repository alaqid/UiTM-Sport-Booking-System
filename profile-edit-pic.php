                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Profile Picture</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                            ...
                                            <div class="col-xl-7">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-username"
                                                        style="color:#575757">Upload your profile
                                                    </label>
                                                    <div class="col-lg-6">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="exampleModalLongTitle">Change Profile <Picture></Picture></h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Are you sure to change your profile picture?
                                                                    </div>
