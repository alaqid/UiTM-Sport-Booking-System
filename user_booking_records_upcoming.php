...
$sql="SELECT * FROM booking_records where userID = $userID AND book_status = 'Upcoming'";
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Upcoming</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                while($rows3=mysqli_fetch_assoc($result3)){
                                                    ...
                                                    echo '<td style="color:#575757">N/A</td>';
                                                }
                                                ...
                                                <td style="color:#575757">
                                                        ...
                                                        <button type="button" class="btn btn-primary"
                                                            data-toggle="modal"
                                                            data-target="#exampleModalCenter">Start</button>
                                                    <!-- Modal -->
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    Are you sure to start your booking?
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary"
                                                                        data-dismiss="modal">Close</button>
                                                                        <a href="user_booking_records_upcoming2.php?bookingID=<?php echo $rows["bookingID"]; ?>">
                                                        <button type="button" class="btn btn-primary"
                                                            data-toggle="modal"
                                                            data-target="#exampleModalCenter">Start</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <td><a
                                                        href="gcalendar2.php?bookingID=<?php echo $rows["bookingID"]; ?>">
                                                        <button class="btn btn-info">Add to Google Calendar</button></a>
                                                </td>
                                                <?php } ?>
                                            </tr>
                                        </tbody>
