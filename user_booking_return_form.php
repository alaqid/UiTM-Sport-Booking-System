...
if (isset($_FILES['my_image'])) {
    ...
    if(count($_POST)>0) {
        ...
        $query ="UPDATE booking_records SET book_status = 'Ended', feedback='".$feedback."', return_proof='".$new_img_name."' WHERE bookingID='".$bookingID."'";
                                            ...
                                            <div class="col-xl-7">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-username"
                                                        style="color:#575757">Upload Proof of Equipment Condition
                                                    </label>
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    Are you sure to return equipment?
                                                                </div>
